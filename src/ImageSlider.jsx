...
class ImageSlider extends React.Component {
  ...
  getImageUrl = idx => (this.props.images[idx]
      ? this.props.images[idx][this.props.imageUrlAccessor]
      : "");
  ...
  renderNav = (length, idx) => ({
      left: this.isRenderLeftNav(length, idx) ? (
          <button
              ...
              onClick={this.onClickNav.bind(this, false)}
          >
              <img
                  src={data[`ImageNavArrowLeft${this.props.navStyle}`]}
      ...
      right: this.isRenderRightNav(length, idx) ? (
          <button
              ...
              onClick={this.onClickNav.bind(this, true)}
          >
              <img
                  src={data[`ImageNavArrowRight${this.props.navStyle}`]}
  ...
  renderSlide = length => (
      <div style={styles.ImageSlider} onClick={this.onClick}>
          <div
              style={this.state.currentSlideStyle}
              onTransitionEnd={this.onSlideEnd}
          />
  ...
  render() {
      const rootStyle = styles.getRootContainer(
          this.props.width,
          this.props.height,
          this.props.bgColor,
      );
      const imageLength = this.props.images.length;
      const leftNav = this.props.showNavs
          ? this.renderNav(imageLength, this.state.idx).left
          : null;
      const rightNav = this.props.showNavs
          ? this.renderNav(imageLength, this.state.idx).right
          : null;
      const bullets = this.props.showBullets
          ? this.renderBullets(imageLength, this.state.idx)
          : null;
